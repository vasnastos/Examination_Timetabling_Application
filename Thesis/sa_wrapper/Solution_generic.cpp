    ...
    public:
        ...
        void solve()
        {
            ...
            while(true)
            {
                ...
                std::map <int,int> rollback;
                previous_cost=this->cost;
                for(auto &mid:moves)
                {
                    rollback[mid.first]=this->s_periods[mid.first];
                }
                this->reposition(moves);
                delta=this->cost-previous_cost;
                if(this->cost<best)
                {
                    best=this->cost;
                    best_sol=this->s_periods;
